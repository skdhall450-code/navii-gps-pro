...
export default function DeviceSetupPage() {
  return <RoleRouteGuard allowedRoles={["SUPER_ADMIN", "ADMIN"]}><DeviceSetup /></RoleRouteGuard>;
}
...
function DeviceSetup() {
  ...
  return <main className="min-h-screen bg-[#050b16] p-4 text-slate-100 sm:p-6 lg:p-8">
    ...
    <section className="rounded-2xl border border-sky-400/20 bg-[#0a1525] p-4 sm:p-6">
      ...
      <p className="mt-2 text-xs leading-5 text-slate-400">Optional placeholders: {"{IMEI}, {SIM}, {SERVER}, {PORT}, {APN}"}. Prepare and send one command at a time in the manufacturer’s specified order.</p>
