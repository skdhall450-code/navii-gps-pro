...
export default function HomePage() {
  return (<><Header /><main>
    ...
    <section className="bg-white py-12"><div className="mx-auto max-w-5xl px-6 text-center"><h2 className="text-2xl font-bold text-slate-900 md:text-3xl">GPS Tracking System in India</h2><p className="mx-auto mt-3 max-w-3xl text-slate-600">NAVII GPS provides GPS tracking systems for cars, trucks, buses and commercial fleets, combining live vehicle location, route history, geofencing, alerts and fleet management software for operations across India.</p><div className="mt-5 flex flex-wrap justify-center gap-3"><Link href="/vehicle-tracking-system" className="rounded-xl border border-slate-300 px-5 py-3 font-semibold text-slate-800 transition hover:bg-slate-100">Vehicle Tracking System</Link><Link href="/software" className="rounded-xl bg-blue-700 px-5 py-3 font-semibold text-white transition hover:bg-blue-800">GPS Fleet Management Software</Link></div></div></section>
