...
export const metadata: Metadata = { title: "GPS Tracker in Jorhat | Vehicle Tracking System", description: "GPS tracker and vehicle tracking solutions in Jorhat for cars, trucks, buses, tea logistics and commercial fleets across Assam.", keywords: uniqueKeywords([...new Set([...["GPS tracker Jorhat", "vehicle tracking Jorhat", "fleet management Jorhat", "truck GPS Jorhat", "commercial vehicle GPS Assam"], ...generateLocalKeywords(city.name, city.sectors)])]), alternates: { canonical: "https://naviigps.com/gps-tracker/jorhat" }, openGraph: { title: "GPS Tracker in Jorhat | NAVII GPS", description: "Vehicle GPS tracking and fleet management solutions in Jorhat.", url: "https://naviigps.com/gps-tracker/jorhat", type: "website", images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: "NAVII GPS tracking solutions in Jorhat" }] } };
