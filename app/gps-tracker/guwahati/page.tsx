...
export const metadata: Metadata = { title: "GPS Tracker in Guwahati | Vehicle Tracking System", description: "GPS trackers and vehicle tracking systems in Guwahati for cars, trucks, buses, logistics and commercial fleets across Assam and the Northeast.", keywords: uniqueKeywords([...new Set([...["GPS tracker in Guwahati", "GPS tracker Guwahati", "vehicle tracking system Guwahati", "car GPS tracker Guwahati", "fleet management Assam", "truck GPS Guwahati", "commercial vehicle GPS Northeast India"], ...generateLocalKeywords(city.name, city.sectors)])]), alternates: { canonical: "https://naviigps.com/gps-tracker/guwahati" }, openGraph: { title: "GPS Tracker in Guwahati | NAVII GPS", description: "Vehicle GPS tracking and fleet management solutions in Guwahati.", url: "https://naviigps.com/gps-tracker/guwahati", type: "website", images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: "NAVII GPS tracking solutions in Guwahati" }] } };
