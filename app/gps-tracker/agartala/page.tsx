...
export const metadata: Metadata = {
  alternates: { canonical: "https://naviigps.com/gps-tracker/agartala" },
  openGraph: { title: "GPS Tracker in Agartala | Vehicle Tracking System | NAVII GPS", description: "GPS tracker and vehicle tracking solutions in Agartala, Tripura for cars, trucks, buses and commercial fleets.", url: "https://naviigps.com/gps-tracker/agartala", type: "website", images: ["/og-image.jpg"] },
