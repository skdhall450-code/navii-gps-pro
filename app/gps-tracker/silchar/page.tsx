...
export const metadata: Metadata = { title: "GPS Tracker in Silchar | Vehicle Tracking System", description: "GPS tracker and vehicle tracking solutions in Silchar for cars, trucks, buses, regional logistics and commercial fleets across Assam and Northeast India.", keywords: uniqueKeywords([...new Set([...["GPS tracker Silchar", "vehicle tracking Silchar", "fleet management Silchar", "truck GPS Silchar", "commercial vehicle GPS Assam"], ...generateLocalKeywords(city.name, city.sectors)])]), alternates: { canonical: "https://naviigps.com/gps-tracker/silchar" }, openGraph: { title: "GPS Tracker in Silchar | NAVII GPS", description: "Vehicle GPS tracking and fleet management solutions in Silchar.", url: "https://naviigps.com/gps-tracker/silchar", type: "website", images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: "NAVII GPS tracking solutions in Silchar" }] } };
