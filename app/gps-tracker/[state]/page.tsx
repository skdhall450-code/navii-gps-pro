...
export default async function StateGpsTrackerPage({ params }: PageProps) {
  ...
  const structuredData = { "@context": "https://schema.org", "@graph": [
    ...
    { "@type": "Service", name: `GPS Tracking Solutions in ${state.name}`, serviceType: "Vehicle GPS Tracking and Fleet Management", provider: { "@id": "https://naviigps.com/#organization" }, areaServed: { "@type": "State", name: state.name }, url },
