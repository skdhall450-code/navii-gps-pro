...
export const metadata: Metadata = { title: "GPS Tracker in Hyderabad | Vehicle Tracking System", description: "GPS trackers and vehicle tracking systems in Hyderabad for cars, pharma logistics, staff transport, delivery vehicles and commercial fleets across Telangana.", keywords: uniqueKeywords([...new Set([...["GPS tracker in Hyderabad", "GPS tracker Hyderabad", "vehicle tracking system Hyderabad", "car GPS tracker Hyderabad", "fleet management software Hyderabad", "commercial vehicle GPS Telangana"], ...generateLocalKeywords(city.name, city.sectors)])]), alternates: { canonical: "https://naviigps.com/gps-tracker/hyderabad" }, openGraph: { title: "GPS Tracker in Hyderabad | NAVII GPS", description: "Vehicle GPS tracking and fleet management solutions in Hyderabad.", url: "https://naviigps.com/gps-tracker/hyderabad", type: "website", images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: "NAVII GPS tracking solutions in Hyderabad" }] } };
