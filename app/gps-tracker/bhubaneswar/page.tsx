...
export const metadata: Metadata = { title: "GPS Tracker in Bhubaneswar | Vehicle Tracking System | NAVII GPS", description: "GPS trackers and vehicle tracking systems in Bhubaneswar for cars, buses, logistics, employee transport and commercial fleets across Odisha.", keywords: ["GPS tracker in Bhubaneswar", "GPS tracker Bhubaneswar", "vehicle tracking system Bhubaneswar", "car GPS tracker Bhubaneswar", "fleet management Odisha", "truck GPS Odisha", "commercial vehicle GPS Bhubaneswar"], alternates: { canonical: "https://naviigps.com/gps-tracker/bhubaneswar" }, openGraph: { title: "GPS Tracker in Bhubaneswar | NAVII GPS", description: "Vehicle GPS tracking and fleet management solutions in Bhubaneswar.", url: "https://naviigps.com/gps-tracker/bhubaneswar", type: "website", images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: "NAVII GPS tracking solutions in Bhubaneswar" }] } };
