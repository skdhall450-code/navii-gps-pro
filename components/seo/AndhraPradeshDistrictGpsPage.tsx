...
import type { AndhraPradeshDistrictSeo } from "@/lib/seo/andhraPradeshDistricts";
import { getAndhraPradeshCitiesForDistrict, getAndhraPradeshCityPath } from "@/lib/seo/andhraPradeshCities";

const districtFaqs = (district: AndhraPradeshDistrictSeo) => [
  {
  ...
  },
  {
    ...
    answer: `Planning can include ${district.cities.join(", ")} and connected routes across Andhra Pradesh. Actual network and installation availability are confirmed before deployment.`,
  },
  {
...
export function AndhraPradeshDistrictGpsPage({ district }: { district: AndhraPradeshDistrictSeo }) {
  const cityGuides = getAndhraPradeshCitiesForDistrict(district.slug);
    ...
    "@graph": [
      {
        ...
        "@id": `${url}#webpage`,
        url,
        name: `GPS Tracker in ${district.name} District, Andhra Pradesh | NAVII GPS`,
        description: `Vehicle GPS tracking and fleet management planning for ${district.name} district in Andhra Pradesh.`,
        isPartOf: { "@id": "https://naviigps.com/#website" },
        inLanguage: "en-IN",
      },
      {
        "@type": "Service",
        name: `GPS Tracking Solutions in ${district.name} District, Andhra Pradesh`,
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Andhra Pradesh", item: "https://naviigps.com/gps-tracker/andhra-pradesh" },
