...
import type { TamilNaduDistrictSeo } from "@/lib/seo/tamilNaduDistricts";
import { getTamilNaduCitiesForDistrict, getTamilNaduCityPath } from "@/lib/seo/tamilNaduCities";

const districtFaqs = (district: TamilNaduDistrictSeo) => [
  {
  ...
  },
  {
    ...
    answer: `Planning can include ${district.cities.join(", ")} and connected routes across Tamil Nadu. Actual network and installation availability are confirmed before deployment.`,
  },
  {
...
export function TamilNaduDistrictGpsPage({ district }: { district: TamilNaduDistrictSeo }) {
  const cityGuides = getTamilNaduCitiesForDistrict(district.slug);
    ...
    "@graph": [
      {
        ...
        "@id": `${url}#webpage`,
        url,
        name: `GPS Tracker in ${district.name} District, Tamil Nadu | NAVII GPS`,
        description: `Vehicle GPS tracking and fleet management planning for ${district.name} district in Tamil Nadu.`,
        isPartOf: { "@id": "https://naviigps.com/#website" },
        inLanguage: "en-IN",
      },
      {
        "@type": "Service",
        name: `GPS Tracking Solutions in ${district.name} District, Tamil Nadu`,
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Tamil Nadu", item: "https://naviigps.com/gps-tracker/tamil-nadu" },
