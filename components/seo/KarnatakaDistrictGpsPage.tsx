...
const districtFaqs = (district: KarnatakaDistrictSeo) => [
  ...
  },
  {
    ...
    answer: `Planning can include ${district.cities.join(", ")} and connected routes across Karnataka. Actual network and installation availability are confirmed before deployment.`,
  },
  {
    ...
    "@graph": [
      {
        ...
        "@id": `${url}#webpage`,
        url,
        name: `GPS Tracker in ${district.name} District, Karnataka | NAVII GPS`,
        description: `Vehicle GPS tracking and fleet management planning for ${district.name} district in Karnataka.`,
        isPartOf: { "@id": "https://naviigps.com/#website" },
        inLanguage: "en-IN",
      },
      {
        "@type": "Service",
        name: `GPS Tracking Solutions in ${district.name} District, Karnataka`,
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Karnataka", item: "https://naviigps.com/gps-tracker/karnataka" },
