...
import type { HaryanaDistrictSeo } from "@/lib/seo/haryanaDistricts";
import { getHaryanaCitiesForDistrict } from "@/lib/seo/haryanaCities";

const districtFaqs = (district: HaryanaDistrictSeo) => [
  {
  ...
  },
  {
    ...
    answer: `Planning can include ${district.cities.join(", ")} and connected routes across Haryana. Network and installation availability are confirmed for the actual operating locations.`,
  },
  {
    ...
    "@graph": [
      {
        ...
        "@id": `${url}#webpage`,
        url,
        name: `GPS Tracker in ${district.name} District, Haryana | NAVII GPS`,
        description: `Vehicle GPS tracking and fleet management planning for ${district.name} district in Haryana.`,
        isPartOf: { "@id": "https://naviigps.com/#website" },
        inLanguage: "en-IN",
      },
      {
        "@type": "Service",
        name: `GPS Tracking Solutions in ${district.name} District`,
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Haryana", item: "https://naviigps.com/gps-tracker/haryana" },
