...
import { Building2, Phone, Mail, Clock3, MessageCircle } from "lucide-react";

const cards = [
  {
    title: "Corporate Office",
    value: "Dera Bassi, Punjab - 140507",
    description:
  ...
  },
  {
    ...
    value: "+91 88997 29705",
    description: "Call us for product consultation",
    icon: Phone,
  },
  {
    title: "Email Support",
    value: "helpline@naviigps.com",
    description: "General: info@naviigps.com",
    icon: Mail,
  },
  {
    title: "Business Hours",
    value: "Mon - Sat",
    description: "09:30 AM - 06:30 PM",
    icon: Clock3,
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-slate-600">
            Contact our sales and support team for GPS tracking, fleet
            management and enterprise IoT solutions.
          </p>
        </div>
          ...
          {cards.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="mt-3 font-semibold text-cyan-700">{item.value}</p>
